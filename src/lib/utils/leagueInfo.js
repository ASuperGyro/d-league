...
export const managers = [
  ...
  },
  {
    ...
    "bio": "I play video games, I like long walks on the beach, my favorite sports teams I watch are Dortmund for soccer, Magic for NBA, and Saints for NFL, and my combine stats are 5’10 225lbs 5.0 40 yard dash 69 inch wingspan. I’m trying to be more like Charles Barkley everyday. Phone Number:407-312-9810.",
    ...
    "location": "Orlando/Mills50",
    "bio": "I'm an ICU nurse originally from Gainesville, FL who moved to Orlando a few years ago to be closer/live with my girlfriend. I'm a diehard packers fan and currently in grad school. If you need someone to shove an IV in you, I know a guy.",
    ...
    "bio": "I have 2 cats and I like football and strategy vidja gaimes. I also make music sometimes.",
    ...
    "valuePosition": "RB",
    "rookieOrVets": "LDC",
    "philosophy": "Win with starting lineup and no depth.",
    "tradingScale": 4,
    "preferredContact": "Sleeper",
    },
    {
    ...
    "name": "Brad Landers",
    "location": "Girlfriend's House, RI",
    "bio": "ahhhhhmmmmmmmmm🤌🤌 Will throw down with anyone on a pickle ball court anywhere at any time.",
    ...
    "name": "Michael Logan",
    "location": "Winter Springs",
    "bio": "I like money….which is why I won the league. Goes by Mikey.",
    ...
    "valuePosition": "WR",
    "rookieOrVets": "BDC",
    "philosophy": "Do better than Michael Bradley.",
    "tradingScale": 8,
    "preferredContact": "Sleeper",
    },
    {
    ...
    },
   {
    ...
    "name": "David Jablon",
    "location": "Maitland",
    "bio": "Ex-soccer player, massive gambler, Travel Nurse Recruiter, love sports. Golf.",
    ...
    "valuePosition": "WR",
    "rookieOrVets": "LDC",
    "philosophy": "Looking to get younger and build for the future.",
    "tradingScale": 7,
    "preferredContact": "Text",
    },
    {
